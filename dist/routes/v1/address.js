...
const createAddressValidation = [
    ...
    (0, express_validator_1.body)('provincia')
        .notEmpty()
        .withMessage('Provincia é obrigatória')
        .isLength({ max: 50 })
        .withMessage('Provincia deve ter no máximo 50 caracteres'),
    (0, express_validator_1.body)('municipio')
        .notEmpty()
        .withMessage('Municipio é obrigatório')
        .isLength({ max: 50 })
        .withMessage('Municipio deve ter no máximo 50 caracteres'),
    ...
    (0, express_validator_1.body)('rua_ou_avenida')
        .notEmpty()
        .withMessage('Rua ou avenida é obrigatória')
        .isLength({ max: 50 })
        .withMessage('Rua ou avenida deve ter no máximo 50 caracteres'),
    (0, express_validator_1.body)('numero_da_casa')
        .notEmpty()
        .withMessage('Número da casa é obrigatório')
        .isLength({ max: 50 })
        .withMessage('Número da casa deve ter no máximo 50 caracteres')
        .trim(),
    (0, express_validator_1.body)('ponto_de_referencia').optional(),
];
const updateAddressValidation = [
    (0, express_validator_1.param)('address_id').notEmpty().withMessage('ID do endereço é obrigatório'),
    (0, express_validator_1.body)('provincia')
        .optional()
        .isLength({ max: 50 })
        .withMessage('Provincia deve ter no máximo 10 caracteres')
        .trim()
        .escape(),
    (0, express_validator_1.body)('municipio')
        .optional()
    ...
    (0, express_validator_1.body)('numero_da_casa')
        ...
        .trim()
        .escape(),
    (0, express_validator_1.body)('ponto_de_referencia').optional().trim().escape(),
];
