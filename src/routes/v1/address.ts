...
const createAddressValidation = [
  ...
  body('numero_da_casa')
    ...
    .trim(), // Mantenha apenas trim para número da casa se quiser
  body('ponto_de_referencia').optional(),
];
const updateAddressValidation = [
	param('address_id').notEmpty().withMessage('ID do endereço é obrigatório'),
	body('provincia')
		.optional()
		.isLength({ max: 50 })
	...
	body('numero_da_casa')
		...
		.trim()
		.escape(),
	body('ponto_de_referencia').optional().trim().escape(),
];
